...
public class DeviceRestExceptionHandler {
	...
	public ResponseEntity<DeviceErrorResponse> handleException(DeviceNotFoundException exc) {
		...
		DeviceErrorResponse error = new DeviceErrorResponse(HttpStatus.NOT_FOUND.value(), exc.getMessage(), System.currentTimeMillis());		
	...
	public ResponseEntity<DeviceErrorResponse> handleException(Exception exc) {
		...
		// create a DeviceErrorResponse
		DeviceErrorResponse error = new DeviceErrorResponse(HttpStatus.BAD_REQUEST.value(), exc.getMessage(), System.currentTimeMillis());
